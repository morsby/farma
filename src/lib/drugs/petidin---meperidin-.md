...
Farmakokinetik: Hurtigere virkningsindsættelse og kortere varighed (3 timer) =>
større risiko for afhængighedsudvikling. Biotilg. 50% (højere ved
leverinsufficiens). Metaboliseres i lever, bl.a. til norpeptidin (kan
akkumuleres ved nyreinsufficiens). Halveringstid 2-5 timer.

Bivirkninger: Foruden almene desuden kramper (pga. metabolits (norpeptidin)
CNS-excitatoriske egenskaber.
